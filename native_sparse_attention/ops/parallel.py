...
try:
    ...
    from native_sparse_attention.ops.fla_compat import mean_pooling
    from native_sparse_attention.ops.fla_compat import prepare_chunk_indices, prepare_chunk_offsets, prepare_lens
    from native_sparse_attention.ops.fla_compat import prepare_token_indices
    from native_sparse_attention.ops.fla_compat import autocast_custom_bwd, autocast_custom_fwd, contiguous
